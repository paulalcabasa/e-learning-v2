...
<script>
	...
	new Vue({
		...
		methods: {
			...
			getProfile: function(trainee_id) {
				axios.get(`${base_url}/trainee/profile/get/${trainee_id}`)
			    .then(({data}) => {
					this.form = data;
			    })
			    .catch((err) => {
			...
			updatePassword: function() {
			    axios.put(`${base_url}/trainee/profile/update/${TRAINEE_ID}`, this.form)
			    .then(({data}) => {
